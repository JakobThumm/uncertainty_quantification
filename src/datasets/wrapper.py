...
def augmented_dataloader_from_string(
    ...
    if dataset_name == "Sinusoidal":
        ...
        train_loader, valid_loader, test_loader = get_celeba_augmented(
            batch_size=batch_size, shuffle=shuffle, seed=seed, download=download, data_path=data_path
        )
...
def dataloader_from_string(
    ...
    if dataset_name == "Sinusoidal":
        ...
        test_loader = get_subset_loader(test_loader, 100, batch_size=batch_size, shuffle=shuffle, seed=seed)
        ...
        train_loader, valid_loader, test_loader = get_celeba(
            batch_size=batch_size, shuffle=shuffle, seed=seed, download=False, data_path=data_path
        )
        ...
        train_loader, valid_loader, test_loader = get_celeba_ood(
            only_with=only_with, batch_size=batch_size, shuffle=shuffle, seed=seed, download=False, data_path=data_path
        )
    elif dataset_name == "ImageNet":
        train_loader, valid_loader, _ = get_imagenet_id(
            batch_size=batch_size,
        ...
        test_loader = get_subset_loader(test_loader, 1000, batch_size=batch_size, shuffle=shuffle, seed=seed)
